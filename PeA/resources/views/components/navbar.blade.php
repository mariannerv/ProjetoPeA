        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                ...
                <path d="M8 1a5 5 0 0 1 5 5v3.993l.764 2.543a1 1 0 0 1-.97 1.321H2.206a1 1 0 0 1-.97-1.321L2 9.993V6a5 5 0 0 1 5-5zm0 1a4 4 0 0 0-4 4v3.8l-.682 2.27a.5.5 0 0 0 .485.646h9.394a.5.5 0 0 0 .485-.646L12 9.8V6a4 4 0 0 0-4-4z"/>
              </svg>
              <span class="badge bg-danger">3</span> <!-- Example badge for 3 unread notifications -->
            </a>
