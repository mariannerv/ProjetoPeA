                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                                <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.5-14.5a.5.5 0 0 1 1 0V2a.5.5 0 0 1 1 0v-.5a1.5 1.5 0 1 0-3 0V2a.5.5 0 0 1 1 0v-.5zM14 6.5a5 5 0 0 0-10 0v4a2 2 0 0 1-2 2v1h14v-1a2 2 0 0 1-2-2v-4z"/>
                                <span class="badge bg-danger">{{ count($notifications) }}</span>
                            </svg>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                            @foreach($notifications as $notification)
                                <li><a class="dropdown-item" href="#">{{ $notification->data['message'] ?? 'No details' }}</a></li>
                            @endforeach
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-2 2-6 2s-6-1-6-2 2-6 6-6 6 5 6 6m-1 0c0-.455-.204-1.326-.777-2.084C11.659 10.075 10.485 9.5 8 9.5c-2.485 0-3.658.576-4.223 1.416C3.204 11.674 3 12.545 3 13h10z"/>
                            </svg>
                            Usuário
                        </a>
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end">
