...
<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item">
                <a href="http://localhost:8000login" class="nav-link active" aria-current="page">
            ...
            <li class="nav-item">
                <a href="http://localhost:8000/chooseaccounttype" class="nav-link active" aria-current="page">
